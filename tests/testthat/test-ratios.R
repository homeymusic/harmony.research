test_that("up ratios within the primary octave match expectations", {
  expect_equal(ratios()$up.numerators,  c(1,16,9,6,5,4,7,3,8,5,16,15,2))
  expect_equal(ratios()$up.denominators,c(1,15,8,5,4,3,5,2,5,3, 9, 8,1))
})
...
test_that("down ratios within the primary octave match expectations", {
  expect_equal(ratios()$down.numerators,  c(1, 8, 9,3,5,2,5,3,4,5,8,15,1))
  expect_equal(ratios()$down.denominators,c(2,15,16,5,8,3,7,4,5,6,9,16,1))
})
